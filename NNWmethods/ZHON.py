...
class Zhon_tools():
    def __init__(self)-> None:
        super(Zhon_tools, self).__init__()
...
# initialisation
num_class=10
network=vgg16(num_classes=num_class+1).to(device)
    [...]
# watermarking
tools = Zhon_tools()
folder = 'resources/zhon/'
power = 10
size = 26
method = 'visible'
watermarking_dict = {'folder': folder, 'size': size, 'power': power, 'method': method, 'dataset': trainset,
                     'num_class': num_class, 'transform': inference_transform}
'''
